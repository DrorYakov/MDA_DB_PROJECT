...
2. **יבוא קבצי CSV:** [יש לתאר כאן את הכלי שבו השתמשתם, למשל: השתמשנו ב-Import Data של pgAdmin / DBeaver לייבוא נתוני מטופלים שנוצרו מראש].
3. **סקריפט אוטומטי (Mock Data Generation):** [יש לתאר אם כתבתם סקריפט Python/SQL המייצר נתונים אקראיים לטובת בדיקות עומס].

**צילומי מסך של הכנסת הנתונים:**
* `[מקום לצילום מסך של שיטה 1]`
* `[מקום לצילום מסך של שיטה 2]`
* `[מקום לצילום מסך של שיטה 3]`
